 ...
 * Login Page
 * 
 * Full page login form using FastAPI JWT auth
      ...
      if (!response.ok) {
        ...
        if (data.detail) {
          if (Array.isArray(data.detail)) {
            ...
            errorMsg = data.detail.error.message || 'Login failed';
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ marginTop: '2rem', textAlign: 'center', borderTop: '1px solid var(--ifm-color-emphasis-200)', paddingTop: '1.5rem' }}>
            ...
            <Link to="/signup" style={{ color: 'var(--ifm-color-primary)', fontWeight: 600, textDecoration: 'none' }}>
              Sign up
            </Link>
          </div>
        </div>
